<template>
  <div>
    <Header login="1" status="你好，服务商"></Header>
    <div class="con red">
      <section class="login_main">
        <div class="box">
          <label class="lbl01" for="text"><img><input placeholder="请输入您绑定的邮箱" type="text" name="text" id="text"></label>
          <button>确认</button>
          <span>邮箱不方便？
            <router-link to="forgetpwd">
              <a href="javascript:;">手机找回</a>
            </router-link>
          </span>
        </div>
      </section>
